...
public abstract class EDDTableFromFiles extends EDDTable{ 
    ...
    public boolean lowUpdate(String msg, long startUpdateMillis, int currLang) throws Throwable {
        ...
        if (nChanges > 0) {
            ...
            saveDirTableFileTableBadFiles(standardizeWhat, tDirTable, tFileTable, badFileMap); //throws Throwable
...
//?subscription and onchange actions?
    ...
    /**
     * Update the var destinationMinMax and related (e.g., geospatial_lat...)
     * based on up-to-date minMaxTable.
     *
     * @param tMinMaxTable
     */
